...
class Course(models.Model):
    ...
    subject = models.CharField(max_length=4, choices=SUBJECT_CHOICES, default='')
    number = models.PositiveSmallIntegerField(validators=[MaxValueValidator(9999)], default=0)
    name = models.CharField(max_length=100, default='')
    section = models.CharField(max_length=4, default='')
    roster = models.ManyToManyField(Student, blank=True, related_name="courses") # Use [Student object].courses.all() to see all of a student's courses
...
class Study(models.Model):
    ...
    attendees = models.ManyToManyField(Student, related_name="studies") # Use [Student object].studies.all() to see all of a student's study sessions
